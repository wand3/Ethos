...
const ErrorComponent: React.FC<ErrorComponentProps> = ({ error, onRetry }) => {
  ...
  return (
    <div className="p-4 bg-red-100 border border-red-400 rounded-lg text-red-700 flex flex-col items-center max-w-md mx-auto mt-4">
      <p className="m-0 text-center text-lg">{error}</p>
      {onRetry && (
        <button 
