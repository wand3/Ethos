  ...
  return (
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className="block w-[5rem] xl:mr-8 mx-2" href="#hero">
        ...
        >
          <div className="relative z-2 flex flex-col items-center justify-center m-auto lg:flex-row">
            {navigation.map((item) => (
              <a
                ...
                href={item.url}
                onClick={handleClick}
                className={`block relative font-code text-lg capitalize text-n-1 dark:text-n-2 transition-colors hover:text-color-1 ${
         ...
         <div className="lg:flex items-center sm:m-auto gap-3">

            <div onClick={() => {toggleDarkMode()}} id="toggleDark" className="flex w-fit shrink background-light drop-shadow-lg dark:toggle-nav-dark h-fit px-2 my-3 pt-2 pb-2 items-center rounded-2xl cursor-pointer">
