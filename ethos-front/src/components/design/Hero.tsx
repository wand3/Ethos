...
import ButtomSvg from "../../assets/svg/ButtonSign";
...
export const BottomLine = () => {
  return (
    <>
      ...
      <ButtomSvg className="hidden absolute top-[54.9375rem] left-[2.1875rem] z-2 pointer-events-none xl:block" />

      <ButtomSvg className="hidden absolute top-[54.9375rem] right-[2.1875rem] z-2 pointer-events-none xl:block" />
    </>
  );
};
...
export const HeroGradientPattern = () => {
  return (
    <>
     <div className="absolute h-full w-full bg-black">
        <div className="relative bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px]"></div>
