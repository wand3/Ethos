...
export const LetsTalk = () => {
  ...
  return (
    <div
      className={`fixed lg:w-[96vw] bottom-[1vh] left-1/2 w-[96%]  -translate-x-1/2 z-50 glass-effect backdrop-blur-lg lg:backdrop-blur-lg drop-shadow-md dark:text-white border-[#ffc876] border rounded-md`}
    >
      <div className="flex items-center px-2 lg:px-7.5 xl:px-10 max-lg:py-1">
        ...
        <ButtonMain className="py-1 mr-0 my-[1%] rounded-md ml-auto" href="/projects" white px="2" line>
            Let's Talk
        </ButtonMain>
      </div>
    </div>
