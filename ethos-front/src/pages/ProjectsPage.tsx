                    ...
                    <section>
                        <div className="mx-1 max-w-screen-xl py-8 sm:py-12 md:mx-8">
                            ...
                            <ul className="mt-8 gap-4 sm:grid-cols-1 lg:grid-cols-1 lg:px-10">
                                <li className="flex transition hover:shadow-xl shadow-lg max-w-fit sm:mx-1 sm:px-1 py-1 md:py-2 glass">
                                    ...
                                    <div className="block shrink-0 my-auto">

                                        <img
                                        alt=""
                                        src="https://images.unsplash.com/photo-1609557927087-f9cf8e88de18?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80"
                                        className="aspect-square h-[100px] w-full object-cover transition duration-500 group-hover:scale-105 md:h-[300px]"
                                        />
                                    </div>
